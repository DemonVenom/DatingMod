...
/*
 * Create GirlfriendEntity Object Model
 *
 * Extends from the GirlfriendEntity.
 * Includes entity head, headwear, body, arms, and legs. Designed in BlockBench with ZombieEntity model
 */


public class GirlfriendEntityModel extends EntityModel<GirlfriendEntity> {
    ...
    // Create GirlfriendEntity Object ModelPart lengths, widths, and pivots, and offsets

    public GirlfriendEntityModel() {
    ...
    @Override
    public void setAngles(GirlfriendEntity entity, float limbAngle, float limbDistance, float customAngle, float headYaw, float headPitch) {
